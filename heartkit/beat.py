...
def train_model(params: HeartTrainParams):
    ...
    if env_flag("WANDB"):
        wandb.init(project=f"ecg-{HeartTask.beat}", entity="ambiq", dir=str(params.job_dir))
    ...
    with strategy.scope():
        ...
        model = create_task_model(inputs, HeartTask.beat, params.arch, stages=params.stages)
