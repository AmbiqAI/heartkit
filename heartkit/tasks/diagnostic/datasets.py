...
def prepare(
    ...
    Args:
        x_y (tuple[npt.NDArray, int]): Data and label
        sample_rate (float): Sample rate
    ...
    # y is already multi-hot encoded
...
def load_train_datasets(
    ...
    for ds in datasets:
        ...
        val_file = resolve_ds_cache_path(
            params.val_file, ds=ds, task="diagnostic", frame_size=params.frame_size, sample_rate=params.sampling_rate
        )
        data_generator = get_ds_generator(
            ds=ds,
